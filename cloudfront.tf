...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  provisioner "remote-exec" {
    inline = [
      "sudo su <<END",
      "echo \"<img src='http://${aws_cloudfront_distribution.s3_distribution.domain_name}/${aws_s3_bucket_object.image-upload.key}' align='center' height='550' width='550'>\" >> /var/www/html/index.html",
      "END",
    ]
  }
}